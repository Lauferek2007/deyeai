        ...
        schema = vol.Schema(
            {
                ...
                vol.Optional(CONF_DEYE_PROGRAM_1_CAPACITY_ENTITY, default=""): str,
                ...
                vol.Optional(CONF_DEYE_PROGRAM_2_CAPACITY_ENTITY, default=""): str,
                ...
                vol.Optional(CONF_DEYE_PROGRAM_3_CAPACITY_ENTITY, default=""): str,
