...
ENTITY_PATTERNS = {
    ...
    "deye_program_1_capacity_entity": ["prog1_capacity", "program_1_capacity"],
    ...
    "deye_program_2_capacity_entity": ["prog2_capacity", "program_2_capacity"],
    ...
    "deye_program_3_capacity_entity": ["prog3_capacity", "program_3_capacity"],
}
...
def discover_inverter_entities(hass: HomeAssistant) -> DiscoveryResult:
    ...
    return DiscoveryResult(
        ...
        deye_program_1_capacity_entity=candidates["deye_program_1_capacity_entity"],
        ...
        deye_program_2_capacity_entity=candidates["deye_program_2_capacity_entity"],
        ...
        deye_program_3_capacity_entity=candidates["deye_program_3_capacity_entity"],
        notes=notes,
    )
