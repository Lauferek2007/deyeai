    ...
    def _resolve_discovery(self):
        if not self.entry.data.get(CONF_AUTO_DISCOVERY, True):
            ...
            return DiscoveryResult(
                ...
                deye_program_1_capacity_entity=self.entry.data.get(CONF_DEYE_PROGRAM_1_CAPACITY_ENTITY) or None,
                ...
                deye_program_2_capacity_entity=self.entry.data.get(CONF_DEYE_PROGRAM_2_CAPACITY_ENTITY) or None,
                ...
                deye_program_3_capacity_entity=self.entry.data.get(CONF_DEYE_PROGRAM_3_CAPACITY_ENTITY) or None,
            )
